                            ...
                            @endphp
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            {{-- Show --}}
                                            <a href="{{ route('kategoripemasukan.show', ['kategoripemasukan'=>$kategorimasuks->id]) }}"  class="btn btn-outline-dark btn-sm me-2" >
                                            ...
                                            {{-- Edit --}}
                                            <a href="{{ route('kategoripemasukan.edit', ['kategoripemasukan'=>$kategorimasuks->id]) }}" class="btn btn-outline-dark btn-sm me-2">
